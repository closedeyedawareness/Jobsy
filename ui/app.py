...
def skill_gap_page(catalog, service):
    ...
    # Check skills data is available
    if not getattr(catalog.repository, 'skills', None):
        st.warning("Skill gap analysis requires the **Reference workbook** loaded with skills data. "
                   "Switch to 'Reference workbook' in the sidebar.")
        return
